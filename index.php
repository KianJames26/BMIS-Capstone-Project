...
<body>
    ...
    <section class="section-four">
        <div class="section-four-top">
            <p class="header">BMIS News</p>
        </div>
        <div class="section-four-bottom">
            <div class="section-four-bottom-card">
                <img src="img/news1.jpg" alt="">
                <p class="date">October 26, 2022</p>
                <p class="description">Mahusay na naipamalas ng mga mag-aaral sa Baitang 10 ang kanilang husay at galing sa pagguhit at pagpapahalaga sa Wikang Pambansa...</p>
            </div>
            <div class="section-four-bottom-card">
                <img src="img/news2.jpg" alt="">
                <p class="date">October 26, 2022</p>
                <p class="description">Kaugnay sa pakikiisa ng Pambansang mataas na paaralan ng Barasoain Memorial Integrates School sa selebrasyon ng Buwan ng Wika 2022...</p>
            </div>
            <div class="section-four-bottom-card">
            <img src="img/news3.jpg" alt="">
                <p class="date">October 26, 2022</p>
                <p class="description">Mula sa baitang 9, isang maalab na pagbati para sa mga natatanging kalahok na nagsipagwagi sa naganap na paligsahan sa paglikha ng tula para sa Buwan ng Wikang Pambansa 2022...</p>
            </div>
        </div>
    </section>
    <section class="section-five">
        <div class="section-five-top">
